...
export default function SubtractionScreen({ navigation }) {
  // State variables
  ...
  const generateProblem = () => {
    ...
    let num1 = Math.floor(Math.random() * (range1 - min1)) + min1;
    let num2 = Math.floor(Math.random() * (range2 - min2)) + min2;
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.header}>
        <Text style={styles.headerText}>Arithmetic Trainer: Subtraction</Text>
      </View>
      ...
      <View style={styles.mainContent}>
        <View style={styles.mathLayout}>
          ...
          <Text style={styles.noteText}>
            *The larger number will be the Minuend and the smaller number will be the Subtrahend
          </Text>
